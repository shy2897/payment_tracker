...
class ProductController extends Controller
{
    ...
    public function index(){
        ...
        $monthlyData = Product::selectRaw('YEAR(invoice_date) as year, sub_category as sub_category')
        ...
        $categories = Category::where('category', 'product')->get();
        ...
        return view('products.index', ['products' => $products, 'budgets' => $budgets, 'categories' => $categories, 'monthlyData' => $monthlyData]);
    }
    ...
    public function create(){
        $category = Category::where('category', 'product')->get();
        return view('products.create', ['category' => $category]);
    }

    public function create_approval(){
        return view('products.approval_create');
    }
    ...
    public function store(Request $request){
        ...
        $budget = Budget::where('category', 'product')->where('year', $year)->first();
        $category = Category::where('category', 'product')->where('sub_category', $product->sub_category)->first();
    ...
    public function search_data(Request $request){
        ...
        Budget::where('category', 'product')
            ->update(['balance' => DB::raw('subtraction + budget')]);
    
        Category::where('category', 'product')
            ->update(['balance' => DB::raw('subtraction + budget')]);
        ...
        return view('products.search', ['products' => $products, 'budgets' => $budgets, 'categories' => $categories, 'monthlyData' => $monthlyData]);
    }
    ...
    public function test(){
        ...
        return view('products.test', ['products' => $products, 'budgets' => $budgets, 'monthlyData' => $monthlyData]);
    }
