...
class ChangeController extends Controller
{
    ...
    public function index(){
        ...
        $products = Change::get();
        $monthlyData = Change::selectRaw('YEAR(invoice_date) as year, sub_category as sub_category')
        ...
        $budgets = Budget::where('category', 'change')->get();
        foreach($budgets as $budget){
            $budget->balance = $budget->subtraction + $budget->budget;
            $budget->save();
        }
        $categories = Category::where('category', 'change')->get();
        ...
        return view('changes.index', ['products' => $products, 'budgets' => $budgets, 'categories' => $categories, 'monthlyData' => $monthlyData]);
    }
    ...
    public function usd_rate(Request $request, $id){
        ...
        $product = Change::where('id',$id)->first();
    ...
    public function create(){
        $category = Category::where('category', 'change')->get();
        return view('changes.create', ['category' => $category]);
    }

    public function create_approval(){
        return view('changes.approval_create');
    }
    ...
    public function store(Request $request){
        ...
        if ($request->hasFile('file')) {
            ...
            $request->file->move(public_path('changes'), $fileName);
        ...
        $budget = Budget::where('category', 'change')->where('year', $year)->first();
        $category = Category::where('category', 'change')->where('sub_category', $product->sub_category)->first();
    ...
    public function edit($id){
        ...
        $product = Change::where('id',$id)->first();
        return view('changes.edit',['product' => $product]);
    }
    ...
    return view('changes.show', ['product' => $product]);
    }
    ...
    public function search_data(Request $request){
        ...
        Budget::where('category', 'change')
            ->update(['balance' => DB::raw('subtraction + budget')]);
    
        Category::where('category', 'change')
            ->update(['balance' => DB::raw('subtraction + budget')]);
        ...
        return view('changes.search', ['products' => $products, 'budgets' => $budgets, 'categories' => $categories, 'monthlyData' => $monthlyData]);
    }
    ...
    public function test(){
        ...
        return view('changes.test', ['products' => $products, 'budgets' => $budgets, 'monthlyData' => $monthlyData]);
    }


    public function generatePdf($year, $month){
        $products = Change::get(); // Retrieve all products (You might want to filter them based on the year and month)
        $monthlyData = Change::selectRaw('YEAR(invoice_date) as year, sub_category as sub_category')
        ->groupBy('year', 'sub_category')
        ->orderBy('year', 'desc')
        ->get();
