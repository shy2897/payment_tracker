...
class OpexController extends Controller
{
    ...
    public function index(){
        ...
        $products = Opex::get();
        $monthlyData = Opex::selectRaw('YEAR(invoice_date) as year, sub_category as sub_category')
        ...
        $budgets = Budget::where('category', 'opex')->get();
        foreach($budgets as $budget){
            $budget->balance = $budget->subtraction + $budget->budget;
            $budget->save();
        }
        $categories = Category::where('category', 'opex')->get();
        ...
        return view('opexs.index', ['products' => $products, 'budgets' => $budgets, 'categories' => $categories, 'monthlyData' => $monthlyData]);
    }
    ...
    public function usd_rate(Request $request, $id){
        ...
        $product = Opex::where('id',$id)->first();
    ...
    public function create(){
        $category = Category::where('category', 'opex')->get();
        return view('opexs.create', ['category' => $category]);
    }

    public function create_approval(){
        return view('opexs.approval_create');
    }
    ...
    public function store(Request $request){
        ...
        if ($request->hasFile('file')) {
            ...
            $request->file->move(public_path('opexs'), $fileName);
        ...
        $budget = Budget::where('category', 'opex')->where('year', $year)->first();
        $category = Category::where('category', 'opex')->where('sub_category', $product->sub_category)->first();
    ...
    public function edit($id){
        ...
        $product = Opex::where('id',$id)->first();
        return view('opexs.edit',['product' => $product]);
    }
    ...
    return view('opexs.show', ['product' => $product]);
    }
    ...
    public function search_data(Request $request){
        ...
        Budget::where('category', 'opex')
            ->update(['balance' => DB::raw('subtraction + budget')]);
    
        Category::where('category', 'opex')
            ->update(['balance' => DB::raw('subtraction + budget')]);
        ...
        return view('opexs.search', ['products' => $products, 'budgets' => $budgets, 'categories' => $categories, 'monthlyData' => $monthlyData]);
    }
    ...
    public function test(){
        ...
        $products = Opex::get();
        $monthlyData = Opex::selectRaw('YEAR(invoice_date) as year, MONTH(invoice_date) as month')
        ->groupBy('year', 'month')
        ->orderBy('year', 'desc')
        ->orderBy('month', 'desc')
        ->get();
        ...
        return view('opexs.test', ['products' => $products, 'budgets' => $budgets, 'monthlyData' => $monthlyData]);
    }


    public function generatePdf($year, $month){
        $products = Opex::get(); // Retrieve all products (You might want to filter them based on the year and month)
        $monthlyData = Opex::selectRaw('YEAR(invoice_date) as year, sub_category as sub_category')
        ->groupBy('year', 'sub_category')
        ->orderBy('year', 'desc')
        ->get();
