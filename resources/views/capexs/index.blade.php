    ...
    <div class="search-bar col-md-3">
        <div class="box">
            <div class="search-box">
                <form action="project_capex/search_data" method="GET">
        ...
        @endforeach
            ...
            <div class="d-flex table_display justify-content-between">
                <div class="col-md-4 d-flex align-items-center">
                    ...
                    <a href="{{ route('project_capex.generatePdf', ['year' => $record->year, 'month' => $record->sub_category]) }}" class="btn btn-sm btn-dark d-inline rounded">Generate PDF</a>
                </div>
                ...
                <tbody>
                    ...
                    @if (date("Y", strtotime($product->invoice_date)) == $record->year && $product->sub_category == $record->sub_category)
                            <tr class="">
                                ...
                                <td>
                                        <a href="/project_capex/{{ $product->id }}/show" class="">
                                ...
                                <td>
                                    ...
                                    <a href="project_capex/{{ $product->id }}/show"
                                    ...
                                    @else
                                        <a href="project_capex/{{ $product->id }}/edit" class="btn btn-outline-info btn-sm rounded-button">
                                            <i class="fa-solid fa-pen-to-square"></i>
                                        </a>
                                    @endif
    ...
    <script>
        ...
        $('#exampleModal').on('show.bs.modal', function (event) {
         ...
         $('#confirmDeleteModal').on('show.bs.modal', function (event) {
            ...
            form.attr('action', 'project_capex/' + productId + '/delete'); // Set the action attribute of the form
        });
