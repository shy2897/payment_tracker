...
<head>
    ...
    <style>
      ...
      .navbar-nav .nav-item.active {
        ...
        border-bottom: 8px solid white; /* Add a bottom border to join with the rest of the page */
      }
  ...
  <nav class="navbar navbar-expand-sm bg-primary" style="position: sticky; top: 0; z-index: 100;">
    ...
    <ul class="navbar-nav mr-auto">
      <li class="nav-item {{ Request::is('admin/dashboard*') ? 'active' : '' }}">
        <a class="nav-link text-light font-weight-bold mx-3" href="/admin/dashboard">Home</a>
      </li>
      <li class="nav-item {{ Request::is('admin/product*') ? 'active' : '' }}">
        <a class="nav-link text-light font-weight-bold mx-3" href="/admin/product">New Project</a>
      </li>
      <li class="nav-item {{ Request::is('admin/annual*') ? 'active' : '' }}">
        <a class="nav-link text-light font-weight-bold mx-3" href="/admin/annual/dashboard">Annual</a>
      </li>
      <li class="nav-item {{ Request::is('admin/change*') ? 'active' : '' }}">
        <a class="nav-link text-light font-weight-bold mx-3" href="/admin/change/dashboard">Change Request</a>
      </li>
    </ul>
